...
let DB = `mongodb+srv://learn:${process.env.MONGO_DB_PASSWORD}@learning-lpcqr.mongodb.net/${process.env.MONGO_DB_NAME}?retryWrites=true&w=majority`;
...
const adminKey = process.env.ADMIN_KEY; // require("../../config/keys").adminKey;
...
const emailPassword = process.env.EMAIL_PASSWORD; // require("../../config/keys").emailPassword;
